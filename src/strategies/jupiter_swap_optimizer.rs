...
pub async fn execute_jupiter_swap(token_in: &str, token_out: &str, amount: f64, jito_client: &JitoClient) -> Result<String> {
...
async fn main() -> Result<()> {
    ...
    execute_jupiter_swap("SOL", "USDC", 0.1, &jito).await?;
    Ok(())
}
